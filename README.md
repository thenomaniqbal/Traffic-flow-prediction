...
To effectively mitigate congestion, modern solutions require advanced predictive modelling techniques that integrate historical and real-time traffic data to predict traffic patterns and optimise traffic flow.Among these approaches, Long Short-Term Memory (LSTM) networks have proven to be particularly effective in modelling sequential traffic behaviour and capturing temporal dependencies within the data.

This study focuses on the development of an LSTM-based predictive model that uses historical traffic data to predict traffic flow two hours into the future.By providing accurate and scalable predictions, the proposed model offers a proactive solution to improve traffic management and reduce congestion.
...
### Literature Review
The literature review for TFP and ITS is based on articles, books and research reports. The data collected will be analysed to identify significant areas of concern.
